...
translation applied. Identityref values (field-id, direction-indicator,
matching-operator, comp-decomp-action) are replaced by their private SID
aliases. The field-length tagged SIDs use the `#6.45(private)` notation.
Target values are encoded as h'hex'.

~~~~
{-150: {23: [
  {1:5, 2:0, 3:-105, 23:[
    {1:0, 2:-25, 5:4, 7:-12, 8:1, 9:[{1:0,2:h'06'}], 12:-1, 16:-5},
    {1:1, 2:-26, 5:8, 7:-12, 8:1, 9:[{1:0,2:h'00'}], 12:-2, 16:-6},
    {1:2, 2:-29, 5:20, 7:-12, 8:1, 9:[{1:0,2:h'00'}], 12:-2, 16:-6},
    {1:3, 2:-30, 5:16, 7:-12, 8:1, 12:-2, 16:-9},
    {1:4, 2:-31, 5:8, 7:-12, 8:1, 9:[{1:0,2:h'11'}], 12:-1, 16:-5},
    {1:5, 2:-32, 5:8, 7:-12, 8:1, 9:[{1:0,2:h'ff'}], 12:-2, 16:-5},
    {1:6, 2:-34, 5:64, 7:-12, 8:1,
     9:[{1:0,2:h'2001066073015c4c'}], 12:-1, 16:-5},
    {1:7, 2:-33, 5:64, 7:-12, 8:1,
     9:[{1:0,2:h'0000000000000005'}], 12:-1, 16:-5},
    {1:8, 2:-36, 5:64, 7:-12, 8:1, 12:-2, 16:-6},
    {1:9, 2:-35, 5:64, 7:-12, 8:1, 12:-2, 16:-6},
    {1:10, 2:-40, 5:16, 7:-12, 8:1, 9:[{1:0,2:h'1633'}], 12:-1, 16:-5},
    {1:11, 2:-41, 5:16, 7:-12, 8:1, 12:-2, 16:-6},
    {1:12, 2:-42, 5:16, 7:-12, 8:1, 9:[{1:0,2:h'00'}], 12:-2, 16:-9},
    {1:13, 2:-43, 5:16, 7:-12, 8:1, 9:[{1:0,2:h'00'}], 12:-2, 16:-9},
    {1:14, 2:-50, 5:2, 7:-12, 8:1, 9:[{1:0,2:h'01'}], 12:-1, 16:-5},
    {1:15, 2:-51, 5:2, 7:-12, 8:1, 9:[{1:0,2:h'01'}], 12:-1, 16:-5},
    {1:16, 2:-52, 5:4, 7:-12, 8:1, 9:[{1:0,2:h'00'}], 12:-2, 16:-6},
    {1:17, 2:-53, 5:8, 7:-12, 8:1,
     9:[{1:0,2:h'05'},{1:1,2:h'07'},{1:2,2:h'45'}], 12:-3, 16:-7},
    {1:18, 2:-56, 5:16, 7:-12, 8:1, 9:[{1:0,2:h'00'}], 12:-2, 16:-6},
    {1:19, 2:-57, 5:#6.45(-16), 6:16, 7:-12, 8:1, 12:-2, 16:-6},
    {1:20, 3:-21, 4:11, 5:#6.45(-18), 7:-13, 8:1,
     9:[{1:0,2:h'63'},{1:1,2:h'73'}], 12:-3, 16:-7},
    {1:21, 3:-21, 4:12, 5:#6.45(-18), 7:-13, 8:1,
     9:[{1:0,2:h'8d'},{1:1,2:h'8e'}], 12:-3, 16:-7},
    {1:22, 3:-21, 4:12, 5:#6.45(-18), 7:-14, 8:1,
     9:[{1:0,2:h'8e'}], 12:-1, 16:-5},
    {1:23, 3:-21, 4:15, 5:#6.45(-18), 7:-13, 8:1,
     9:[{1:0,2:h'643d30'}], 12:-1, 16:-5},
    {1:24, 3:-21, 4:17, 5:#6.45(-18), 7:-13, 8:1,
     9:[{1:0,2:h'8e'}], 12:-1, 16:-5},
  ]}
]}}
~~~~
{: #fig-schc-rule-private title="IPv6/UDP/CoAP compression rule with private SID translation" artwork-align="left"}
